                        ...
                        RetrofitClient.getApiService().postDeleteSubscribeB(myInfo.getUserID(), boardID).enqueue(new Callback<String>() {
                            ...
                            public void onResponse(@NonNull Call<String> call, @NonNull Response<String> response) {
                                ...
                                if (response.code() == 200) {
                                    ...
                                    Toast.makeText(BoardPostListActivity.this, "다시 한번 시도해 주세요:)", Toast.LENGTH_SHORT).show();
                            }

                            @Override
                            public void onFailure(@NonNull Call<String> call, @NonNull Throwable t) {
                                Toast.makeText(BoardPostListActivity.this, "서버와 연결되지 않았습니다. 확인해 주세요.", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                    else {                      //"즐겨찾는 게시판 등록" 선택
