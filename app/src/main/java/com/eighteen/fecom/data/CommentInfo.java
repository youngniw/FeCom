...
public class CommentInfo {
    ...
    public CommentInfo(int commentID, int anonymous, int anonymousNum, int commenterID, String commenterNick, String commentTime, String content, int amILike, int likeNum) {
