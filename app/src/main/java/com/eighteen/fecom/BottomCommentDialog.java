...
public class BottomCommentDialog extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        commentList.add(new CommentInfo(1, 0,-1, 1, "세린", "2021-08-10 20:32:11", "댓글1입니다.", 1, 1));
        commentList.add(new CommentInfo(2, 0, -1, 2, "소은", "2021-08-10 20:42:25", "이거 익명인가?", 1, 38));
        commentList.add(new CommentInfo(3, 0, -1, 2, "영은", "2021-08-11 21:00:14", "나야나!!*_*", 0, 13));
        commentList.add(new CommentInfo(4, 0, -1, 2, "아이스초코", "2021-08-14 21:23:15", "Hello:) Hi", 0, 3));
        commentList.add(new CommentInfo(1, 0,-1, 1, "세린", "2021-08-10 20:32:11", "댓글1입니다.", 1, 1));
        commentList.add(new CommentInfo(2, 0, -1, 2, "소은", "2021-08-10 20:42:25", "이거 익명인가?", 1, 38));
        commentList.add(new CommentInfo(3, 0, -1, 2, "영은", "2021-08-11 21:00:14", "나야나!!*_*", 0, 13));
        commentList.add(new CommentInfo(4, 0, -1, 2, "아이스초코", "2021-08-14 21:23:15", "Hello:) Hi", 0, 3));
